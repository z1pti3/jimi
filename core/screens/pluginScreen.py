...
class selectPlugin:
    def __init__(self,pluginName):
        ...
        response = helpers.apiCall("GET",self.apiEndpoint)
    ...
    def install(self,args):
        ...
        helpers.apiCall("POST",self.apiEndpoint,postAction)
        raise KeyboardInterrupt
    ...
    def showWorkerSettings(self,args):
        ...
        helpers.apiCall("GET",self.apiEndpoint)

from core import api, logging, settings, plugin, screen, helpers
