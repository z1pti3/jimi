    ...
    // "colorize" the widget name
        $.widget("flowchart.flowchart", {
            ...
            _getOperatorFullElement: function (operatorData) {
                ...
                if (operatorData["properties"]["class"] != "flowchart-operator-trigger" && operatorData["properties"]["class"] != "flowchart-operator-action" && operatorData["properties"]["class"] != undefined)
                {
                    var $operator_title = $('<div class="flowchart-operator-title custom-'+operatorData["properties"]["class"].split("-").pop()+'"></div>');
                }
                else
                {
